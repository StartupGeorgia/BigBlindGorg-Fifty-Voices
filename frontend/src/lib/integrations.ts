...
export interface Integration {
  ...
  enabled: boolean;
  isPopular?: boolean;
  isBuiltIn?: boolean; // Fifty Voices built-in integration
  badge?: string; // Custom badge text (e.g., "Fifty Voices", "Popular")
...
export const AVAILABLE_INTEGRATIONS: Integration[] = [
  // Built-in Fifty Voices Tools (No external API needed)
  {
    id: "call_control",
    name: "Call Control",
    slug: "call-control",
